        ...
        <main>
            ...
            <section class="d-flex flex-column justify-content-center" id="Hero">
                <div class="d-flex align-content-center justify-content-center">
                    <h1 id="Hero-Titulo" class="text-center">Plataforma para el transporte de cargas</h1>
                </div>
                <div class="d-flex align-content-center justify-content-center">
                    <span id="Hero-Texto" class="text-center"> Cargas, oportunidades de trabajo, ventas y soluciones digitales
                        para transportistas, empresas y dadores de carga.</span>
                </div>
            ...
            <section id="Seccion-Noticias"
                ...
                <h2 id="titulo-noticias">Noticias y actualidad del transporte</h2>
            ...
            <section id="Seccion-Audiencia"
                ...
                <div class="pb-4 justify-content-center d-flex" id="cont-titulo-parrafo">
                    <h3 id="titulo-audiencia">¿A quién está dirigido Stylo Camión?</h3>
                </div>
            ...
            <section id="Servicios" class="d-flex flex-column justify-content-center align-items-center">
                <div class="text-center pb-5" id="cont-titulo-servicio">
                    <h3 id="titulo-servicios">Accedé a nuestras secciones principales</h3>
                </div>
        ...
        <footer class="d-flex justify-content-center align-items-center gap-5">
            ...
            <div class="gap-5">
                <a id="redes_sociales" class="redes_sociales"
                    ...
                    aria-label="TikTok Stylo Camión"
                ...
                <a id="redes_sociales" class="redes_sociales"
                    ...
                    aria-label="Email Stylo Camión"
                    title="Contactanos por correo">
                ...
                <a id="redes_sociales" class="redes_sociales"
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Instagram Stylo Camión"
                ...
                <a id="redes_sociales" class="redes_sociales"
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Facebook Stylo Camión"
                ...
                <a id="redes_sociales" class="redes_sociales"
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="YouTube Stylo Camión"
